...
public class PlayerControllerMJ : MonoBehaviour
{
    ...
    void Awake()
    {
        if (!PlayerPrefs.HasKey("Volume")) PlayerPrefs.SetFloat("Volume", 0);
    ...
    void Update()
    {
        ...
        playerRb.AddForce(impulseForce * Time.deltaTime * (focalPoint.right * hInput + focalPoint.forward * vInput), ForceMode.Impulse);
